...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (empty($username_err) && empty($password_err) && empty($confirm_password_err)) {
        $sql = "INSERT INTO users (username, password,Add1,Add2,city,state,zip) VALUES (?, ?,'$add1','$add2','$city','$state','$zip')";
        // $sql2="INSERT INTO users (Add1,Add2,city,zip) VALUES ($add1,$add1,$city,$zip)";
        ...
        <form action="" method="post">
            ...
            <div class="form-row">
                <div class="form-group col-md-6 py-1">
                    ...
                    <input type="text" class="form-control" name="city" id="inputCity" placeholder="New York,Seattle..">
                </div>
                <div class="form-group col-md-4 py-1">
                    <label for="inputState">State</label>
                    <input type="text" class="form-control" name="state" id="inputCity" placeholder="California,Texas..">
                    </select>
                </div>
